...
class RBGroupAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('name', 'short_name', 'demo_group', 'approved', 'activated', 'signin_organic_required', 'requires_approval', 'premium', 'send_notifications')
        }),
        ('Advanced', {
            'fields': ('custom_css', 'active_sections', 'anno_whitelist', 'separate_cta', 'separate_cta_expanded', 'temp_interact', 'img_whitelist', 'img_blacklist', 'no_readr', 'word_blacklist', 'img_indicator_show_onload', 'img_indicator_show_side', 'tag_box_bg_colors', 'tag_box_text_colors', 'tag_box_font_family', 'tag_box_gradient', 'tags_bg_css' , 'language')
        }),
        ('Logos', {
        ...
        ('Selectors', {
            'fields': ('post_selector', 'post_href_selector', 'summary_widget_selector', 'summary_widget_method', 'summary_widget_expanded_mobile')
        }),
        ('JQuery', {
