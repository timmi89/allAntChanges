...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.send_notifications'
        db.add_column(u'rb_group', 'send_notifications',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.send_notifications'
        db.delete_column(u'rb_group', 'send_notifications')
