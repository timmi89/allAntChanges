...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Interaction', fields ['content', 'user', 'page', 'interaction_node']
        db.create_unique('rb_interaction', ['content_id', 'user_id', 'page_id', 'interaction_node_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Interaction', fields ['content', 'user', 'page', 'interaction_node']
        db.delete_unique('rb_interaction', ['content_id', 'user_id', 'page_id', 'interaction_node_id'])
