...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SocialAuth.readr_token'
        db.add_column('rb_socialauth', 'readr_token', self.gf('django.db.models.fields.CharField')(default=3, unique=True, max_length=103), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SocialAuth.readr_token'
        db.delete_column('rb_socialauth', 'readr_token')
    ...
    models = {
        ...
        'rb.socialauth': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'readr_token': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '103'}),
