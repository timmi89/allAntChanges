...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupBlessedTag'
        db.create_table('rb_groupblessedtag', (
        ...
        db.send_create_signal('rb', ['GroupBlessedTag'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GroupBlessedTag'
        db.delete_table('rb_groupblessedtag')
