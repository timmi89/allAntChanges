...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.img_indicator_show_onload'
        db.add_column(u'rb_group', 'img_indicator_show_onload',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Group.img_indicator_show_side'
        db.add_column(u'rb_group', 'img_indicator_show_side',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True),
                      keep_default=False)

        # Adding field 'Group.tag_box_bg_colors'
        db.add_column(u'rb_group', 'tag_box_bg_colors',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.tag_box_text_colors'
        db.add_column(u'rb_group', 'tag_box_text_colors',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.tag_box_font_family'
        db.add_column(u'rb_group', 'tag_box_font_family',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.tag_box_gradient'
        db.add_column(u'rb_group', 'tag_box_gradient',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.tags_bg_css'
        db.add_column(u'rb_group', 'tags_bg_css',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.img_indicator_show_onload'
        db.delete_column(u'rb_group', 'img_indicator_show_onload')

        # Deleting field 'Group.img_indicator_show_side'
        db.delete_column(u'rb_group', 'img_indicator_show_side')

        # Deleting field 'Group.tag_box_bg_colors'
        db.delete_column(u'rb_group', 'tag_box_bg_colors')

        # Deleting field 'Group.tag_box_text_colors'
        db.delete_column(u'rb_group', 'tag_box_text_colors')

        # Deleting field 'Group.tag_box_font_family'
        db.delete_column(u'rb_group', 'tag_box_font_family')

        # Deleting field 'Group.tag_box_gradient'
        db.delete_column(u'rb_group', 'tag_box_gradient')

        # Deleting field 'Group.tags_bg_css'
        db.delete_column(u'rb_group', 'tags_bg_css')
