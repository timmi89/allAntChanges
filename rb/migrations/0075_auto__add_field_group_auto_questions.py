...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.auto_questions'
        db.add_column(u'rb_group', 'auto_questions',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.auto_questions'
        db.delete_column(u'rb_group', 'auto_questions')
    ...
    models = {
        ...
        u'rb.group': {
            ...
            'auto_questions': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
