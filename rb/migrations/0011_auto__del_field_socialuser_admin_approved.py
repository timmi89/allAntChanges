...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SocialUser.admin_approved'
        db.delete_column('rb_socialuser', 'admin_approved')


    def backwards(self, orm):
        
        # Adding field 'SocialUser.admin_approved'
        db.add_column('rb_socialuser', 'admin_approved', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
