...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.share'
        db.add_column('rb_group', 'share', self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='Share Feature', unique=True, to=orm['rb.Feature']), keep_default=False)

        # Adding field 'Group.rate'
        db.add_column('rb_group', 'rate', self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='Rate Feature', unique=True, to=orm['rb.Feature']), keep_default=False)

        # Adding field 'Group.comment'
        db.add_column('rb_group', 'comment', self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='Comment Feature', unique=True, to=orm['rb.Feature']), keep_default=False)

        # Adding field 'Group.bookmark'
        db.add_column('rb_group', 'bookmark', self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='Bookmark Feature', unique=True, to=orm['rb.Feature']), keep_default=False)

        # Adding field 'Group.search'
        db.add_column('rb_group', 'search', self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='Search Feature', unique=True, to=orm['rb.Feature']), keep_default=False)
