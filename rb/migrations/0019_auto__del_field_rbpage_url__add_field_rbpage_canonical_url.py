...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RBPage.canonical_url'
        db.add_column('rb_rbpage', 'canonical_url', self.gf('django.db.models.fields.URLField')(default=['datetime'], max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'RBPage.url'
        raise RuntimeError("Cannot reverse this migration. 'RBPage.url' and its values cannot be restored.")

        # Deleting field 'RBPage.canonical_url'
        db.delete_column('rb_rbpage', 'canonical_url')
