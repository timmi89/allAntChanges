...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'GroupAdmin', fields ['group', 'social_user']
        db.create_unique('rb_groupadmin', ['group_id', 'social_user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'GroupAdmin', fields ['group', 'social_user']
        db.delete_unique('rb_groupadmin', ['group_id', 'social_user_id'])
