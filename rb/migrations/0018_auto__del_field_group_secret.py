...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Group.secret'
        raise RuntimeError("Cannot reverse this migration. 'Group.secret' and its values cannot be restored.")
