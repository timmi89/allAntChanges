...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.css_url'
        db.alter_column('rb_group', 'css_url', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Group.css_url'
        db.alter_column('rb_group', 'css_url', self.gf('django.db.models.fields.URLField')(max_length=200))
