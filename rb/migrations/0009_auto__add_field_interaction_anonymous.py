...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Interaction.anonymous'
        db.add_column('rb_interaction', 'anonymous', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Interaction.anonymous'
        db.delete_column('rb_interaction', 'anonymous')
    ...
    models = {
        ...
        'rb.interaction': {
            'Meta': {'ordering': "['path']", 'object_name': 'Interaction'},
