...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.hideOnMobile'
        db.add_column(u'rb_group', 'hideOnMobile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Group.hideDoubleTapMessage'
        db.add_column(u'rb_group', 'hideDoubleTapMessage',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Group.doubleTapMessage'
        db.add_column(u'rb_group', 'doubleTapMessage',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Group.doubleTapMessagePosition'
        db.add_column(u'rb_group', 'doubleTapMessagePosition',
                      self.gf('django.db.models.fields.CharField')(default='bottom', max_length=25),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.hideOnMobile'
        db.delete_column(u'rb_group', 'hideOnMobile')

        # Deleting field 'Group.hideDoubleTapMessage'
        db.delete_column(u'rb_group', 'hideDoubleTapMessage')

        # Deleting field 'Group.doubleTapMessage'
        db.delete_column(u'rb_group', 'doubleTapMessage')

        # Deleting field 'Group.doubleTapMessagePosition'
        db.delete_column(u'rb_group', 'doubleTapMessagePosition')
