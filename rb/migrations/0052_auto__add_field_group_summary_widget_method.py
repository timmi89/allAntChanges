...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.summary_widget_method'
        db.add_column(u'rb_group', 'summary_widget_method',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.summary_widget_method'
        db.delete_column(u'rb_group', 'summary_widget_method')
