...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field node on 'Interaction'
        db.create_table('rb_interaction_node', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('interaction', models.ForeignKey(orm['rb.interaction'], null=False)),
            ('interactionnode', models.ForeignKey(orm['rb.interactionnode'], null=False))
        ))
        db.create_unique('rb_interaction_node', ['interaction_id', 'interactionnode_id'])


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Interaction.node'
        raise RuntimeError("Cannot reverse this migration. 'Interaction.node' and its values cannot be restored.")

        # Removing M2M table for field node on 'Interaction'
        db.delete_table('rb_interaction_node')
