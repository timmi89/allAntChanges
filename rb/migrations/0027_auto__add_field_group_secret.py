...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.secret'
        db.add_column('rb_group', 'secret', self.gf('django.db.models.fields.CharField')(default=u'fbdcd62728abde', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.secret'
        db.delete_column('rb_group', 'secret')
