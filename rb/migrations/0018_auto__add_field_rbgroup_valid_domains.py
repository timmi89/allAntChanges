...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RBGroup.valid_domains'
        db.add_column('rb_rbgroup', 'valid_domains', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RBGroup.valid_domains'
        db.delete_column('rb_rbgroup', 'valid_domains')
