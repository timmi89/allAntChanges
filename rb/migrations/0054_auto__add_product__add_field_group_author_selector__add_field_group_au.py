...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rb_product', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('additionalType', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('alternateName', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('sameAs', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('aggregateRating_ratingValue', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('brand_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('color', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('gtin13', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('gtin14', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('gtin8', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ...
            ('mpn', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('offers_price', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('offers_priceCurrency', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('productID', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('releaseDate', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('sku', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('weight', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('width', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'rb', ['Product'])

        # Adding field 'Group.author_selector'
        db.add_column(u'rb_group', 'author_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.author_attribute'
        db.add_column(u'rb_group', 'author_attribute',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.topics_selector'
        db.add_column(u'rb_group', 'topics_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.topics_attribute'
        db.add_column(u'rb_group', 'topics_attribute',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.section_selector'
        db.add_column(u'rb_group', 'section_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.section_attribute'
        db.add_column(u'rb_group', 'section_attribute',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Page.author'
        db.add_column(u'rb_page', 'author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Page.topics'
        db.add_column(u'rb_page', 'topics',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Page.section'
        db.add_column(u'rb_page', 'section',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'rb_product')

        # Deleting field 'Group.author_selector'
        db.delete_column(u'rb_group', 'author_selector')

        # Deleting field 'Group.author_attribute'
        db.delete_column(u'rb_group', 'author_attribute')

        # Deleting field 'Group.topics_selector'
        db.delete_column(u'rb_group', 'topics_selector')

        # Deleting field 'Group.topics_attribute'
        db.delete_column(u'rb_group', 'topics_attribute')

        # Deleting field 'Group.section_selector'
        db.delete_column(u'rb_group', 'section_selector')

        # Deleting field 'Group.section_attribute'
        db.delete_column(u'rb_group', 'section_attribute')

        # Deleting field 'Page.author'
        db.delete_column(u'rb_page', 'author')

        # Deleting field 'Page.topics'
        db.delete_column(u'rb_page', 'topics')

        # Deleting field 'Page.section'
        db.delete_column(u'rb_page', 'section')
