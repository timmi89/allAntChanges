...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.active_sections'
        db.add_column(u'rb_group', 'active_sections',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.active_sections'
        db.delete_column(u'rb_group', 'active_sections')
