...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Group.css_url'
        db.delete_column('rb_group', 'css_url')

        # Adding field 'Group.custom_css'
        db.add_column('rb_group', 'custom_css', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Group.css_url'
        db.add_column('rb_group', 'css_url', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Deleting field 'Group.custom_css'
        db.delete_column('rb_group', 'custom_css')
