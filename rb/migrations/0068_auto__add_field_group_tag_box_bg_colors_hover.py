...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.tag_box_bg_colors_hover'
        db.add_column(u'rb_group', 'tag_box_bg_colors_hover',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.tag_box_bg_colors_hover'
        db.delete_column(u'rb_group', 'tag_box_bg_colors_hover')
