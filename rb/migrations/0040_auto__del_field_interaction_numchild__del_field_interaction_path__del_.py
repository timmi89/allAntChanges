...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Interaction.numchild'
        db.delete_column('rb_interaction', 'numchild')

        # Deleting field 'Interaction.path'
        db.delete_column('rb_interaction', 'path')

        # Deleting field 'Interaction.depth'
        db.delete_column('rb_interaction', 'depth')

        # Adding field 'Interaction.parent'
        db.add_column('rb_interaction', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rb.Interaction']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Interaction.numchild'
        db.add_column('rb_interaction', 'numchild', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Interaction.path'
        raise RuntimeError("Cannot reverse this migration. 'Interaction.path' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Interaction.depth'
        raise RuntimeError("Cannot reverse this migration. 'Interaction.depth' and its values cannot be restored.")

        # Deleting field 'Interaction.parent'
        db.delete_column('rb_interaction', 'parent_id')
    ...
    models = {
        ...
        'rb.interaction': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rb.Interaction']"}),
