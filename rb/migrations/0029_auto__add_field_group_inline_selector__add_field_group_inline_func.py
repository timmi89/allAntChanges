...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.inline_selector'
        db.add_column('rb_group', 'inline_selector', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Group.inline_func'
        db.add_column('rb_group', 'inline_func', self.gf('django.db.models.fields.CharField')(default='', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.inline_selector'
        db.delete_column('rb_group', 'inline_selector')

        # Deleting field 'Group.inline_func'
        db.delete_column('rb_group', 'inline_func')
    ...
    models = {
        ...
        'rb.group': {
            ...
            'inline_func': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '25'}),
            'inline_selector': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100'}),
