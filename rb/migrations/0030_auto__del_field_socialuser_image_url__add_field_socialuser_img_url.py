...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SocialUser.image_url'
        db.delete_column('rb_socialuser', 'image_url')

        # Adding field 'SocialUser.img_url'
        db.add_column('rb_socialuser', 'img_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SocialUser.image_url'
        db.add_column('rb_socialuser', 'image_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Deleting field 'SocialUser.img_url'
        db.delete_column('rb_socialuser', 'img_url')
