...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Interactions.interaction'
        db.delete_column('rb_interactions', 'interaction_id')

        # Adding field 'Interactions.uc'
        db.add_column('rb_interactions', 'uc', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rb.UserContent']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Interactions.interaction'
        db.add_column('rb_interactions', 'interaction', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rb.Interaction']), keep_default=False)

        # Deleting field 'Interactions.uc'
        db.delete_column('rb_interactions', 'uc_id')
