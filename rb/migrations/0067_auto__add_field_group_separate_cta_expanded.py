...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.separate_cta_expanded'
        db.add_column(u'rb_group', 'separate_cta_expanded',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.separate_cta_expanded'
        db.delete_column(u'rb_group', 'separate_cta_expanded')
