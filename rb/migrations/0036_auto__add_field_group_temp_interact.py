...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.temp_interact'
        db.add_column('rb_group', 'temp_interact', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.temp_interact'
        db.delete_column('rb_group', 'temp_interact')
