...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('rb_comment', 'comment')

        # Adding field 'Comment.content'
        db.add_column('rb_comment', 'content', self.gf('django.db.models.fields.TextField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Comment.comment'
        raise RuntimeError("Cannot reverse this migration. 'Comment.comment' and its values cannot be restored.")
