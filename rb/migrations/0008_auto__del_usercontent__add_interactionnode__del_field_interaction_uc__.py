...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('rb_usercontent')
        ...
        # Deleting field 'Interaction.uc'
        db.delete_column('rb_interaction', 'uc_id')

        # Adding field 'Interaction.node'
        db.add_column('rb_interaction', 'node', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['rb.InteractionNode']), keep_default=False)


    def backwards(self, orm):
        
        # Adding model 'UserContent'
        db.create_table('rb_usercontent', (
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('rb', ['UserContent'])

        # Deleting model 'InteractionNode'
        db.delete_table('rb_interactionnode')

        # Adding field 'Interaction.uc'
        db.add_column('rb_interaction', 'uc', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['rb.UserContent']), keep_default=False)

        # Deleting field 'Interaction.node'
        db.delete_column('rb_interaction', 'node_id')
    ...
    models = {
        ...
        'rb.interaction': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'default': "'Null'", 'to': "orm['rb.Interaction']", 'null': 'True', 'blank': 'True'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
