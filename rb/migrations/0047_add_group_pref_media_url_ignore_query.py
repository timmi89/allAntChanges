...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.media_url_ignore_query'
        db.add_column('rb_group', 'media_url_ignore_query', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.media_url_ignore_query'
        db.delete_column('rb_group', 'media_url_ignore_query')
