...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SocialUser.hometown'
        db.add_column('rb_socialuser', 'hometown', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'SocialUser.bio'
        db.add_column('rb_socialuser', 'bio', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SocialUser.hometown'
        db.delete_column('rb_socialuser', 'hometown')

        # Deleting field 'SocialUser.bio'
        db.delete_column('rb_socialuser', 'bio')
