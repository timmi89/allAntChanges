...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Site.domain'
        db.alter_column('rb_site', 'domain', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Site.domain'
        db.alter_column('rb_site', 'domain', self.gf('django.db.models.fields.CharField')(max_length=50))
