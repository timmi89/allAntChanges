...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Interaction', fields ['parent']
        db.delete_unique('rb_interaction', ['parent_id'])

        # Changing field 'Interaction.parent'
        db.alter_column('rb_interaction', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Interaction'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Interaction.parent'
        db.alter_column('rb_interaction', 'parent_id', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['rb.Interaction'], unique=True))

        # Adding unique constraint on 'Interaction', fields ['parent']
        db.create_unique('rb_interaction', ['parent_id'])
