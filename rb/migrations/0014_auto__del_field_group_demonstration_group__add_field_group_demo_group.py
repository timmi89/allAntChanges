...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.demo_group'
        db.add_column('rb_group', 'demo_group', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Group.demo_group'
        db.delete_column('rb_group', 'demo_group')
