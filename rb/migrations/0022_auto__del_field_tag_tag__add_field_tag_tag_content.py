...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('rb_tag', 'tag')

        # Adding field 'Tag.tag_content'
        db.add_column('rb_tag', 'tag_content', self.gf('django.db.models.fields.CharField')(default=1, max_length=160), keep_default=False)
    ...
    models = {
        ...
        'rb.tag': {
            ...
            'node_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['rb.Node']", 'unique': 'True', 'primary_key': 'True'}),
            'tag_content': ('django.db.models.fields.CharField', [], {'max_length': '160'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'sites.site': {
