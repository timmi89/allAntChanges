...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feature.kind'
        db.add_column('rb_feature', 'kind', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)

        # Adding field 'Feature.rb_group'
        db.add_column('rb_feature', 'rb_group', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rb.RBGroup']), keep_default=False)
        ...
        # Adding field 'RBGroup.anno_whitelist'
        db.add_column('rb_rbgroup', 'anno_whitelist', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'RBGroup.img_whitelist'
        db.add_column('rb_rbgroup', 'img_whitelist', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'RBGroup.img_blacklist'
        db.add_column('rb_rbgroup', 'img_blacklist', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'RBGroup.no_readr'
        db.add_column('rb_rbgroup', 'no_readr', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'RBGroup.logo_url_sm'
        db.add_column('rb_rbgroup', 'logo_url_sm', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'RBGroup.logo_url_med'
        db.add_column('rb_rbgroup', 'logo_url_med', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'RBGroup.logo_url_lg'
        db.add_column('rb_rbgroup', 'logo_url_lg', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feature.kind'
        db.delete_column('rb_feature', 'kind')

        # Deleting field 'Feature.rb_group'
        db.delete_column('rb_feature', 'rb_group_id')
        ...
        # Deleting field 'RBGroup.anno_whitelist'
        db.delete_column('rb_rbgroup', 'anno_whitelist')

        # Deleting field 'RBGroup.img_whitelist'
        db.delete_column('rb_rbgroup', 'img_whitelist')

        # Deleting field 'RBGroup.img_blacklist'
        db.delete_column('rb_rbgroup', 'img_blacklist')

        # Deleting field 'RBGroup.no_readr'
        db.delete_column('rb_rbgroup', 'no_readr')

        # Deleting field 'RBGroup.logo_url_sm'
        db.delete_column('rb_rbgroup', 'logo_url_sm')

        # Deleting field 'RBGroup.logo_url_med'
        db.delete_column('rb_rbgroup', 'logo_url_med')

        # Deleting field 'RBGroup.logo_url_lg'
        db.delete_column('rb_rbgroup', 'logo_url_lg')
    ...
    models = {
        ...
        'rb.rbgroup': {
            ...
            'anno_whitelist': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'css_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'img_blacklist': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'img_whitelist': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            ...
            'no_readr': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
