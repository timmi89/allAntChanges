...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.broadcast_selector'
        db.add_column(u'rb_group', 'broadcast_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.broadcast_headline'
        db.add_column(u'rb_group', 'broadcast_headline',
                      self.gf('django.db.models.fields.CharField')(default='Popular Reactions', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.broadcast_background'
        db.add_column(u'rb_group', 'broadcast_background',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.broadcast_jquery_method'
        db.add_column(u'rb_group', 'broadcast_jquery_method',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.broadcast_selector'
        db.delete_column(u'rb_group', 'broadcast_selector')

        # Deleting field 'Group.broadcast_headline'
        db.delete_column(u'rb_group', 'broadcast_headline')

        # Deleting field 'Group.broadcast_background'
        db.delete_column(u'rb_group', 'broadcast_background')

        # Deleting field 'Group.broadcast_jquery_method'
        db.delete_column(u'rb_group', 'broadcast_jquery_method')
    ...
    models = {
        ...
        u'rb.group': {
            ...
            'broadcast_background': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'broadcast_headline': ('django.db.models.fields.CharField', [], {'default': "'Popular Reactions'", 'max_length': '255', 'blank': 'True'}),
            'broadcast_jquery_method': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'broadcast_selector': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
