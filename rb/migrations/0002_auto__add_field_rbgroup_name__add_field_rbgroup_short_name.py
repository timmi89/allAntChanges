...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RBGroup.name'
        db.add_column('rb_rbgroup', 'name', self.gf('django.db.models.fields.CharField')(default='samplename', max_length=250), keep_default=False)

        # Adding field 'RBGroup.short_name'
        db.add_column('rb_rbgroup', 'short_name', self.gf('django.db.models.fields.CharField')(default='sfds', max_length=25), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RBGroup.name'
        db.delete_column('rb_rbgroup', 'name')
