...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.summary_widget_expanded_mobile'
        db.add_column(u'rb_group', 'summary_widget_expanded_mobile',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.summary_widget_expanded_mobile'
        db.delete_column(u'rb_group', 'summary_widget_expanded_mobile')
