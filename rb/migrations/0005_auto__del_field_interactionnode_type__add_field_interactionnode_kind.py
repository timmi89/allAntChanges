...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'InteractionNode.type'
        db.delete_column('rb_interactionnode', 'type')

        # Adding field 'InteractionNode.kind'
        db.add_column('rb_interactionnode', 'kind', self.gf('django.db.models.fields.CharField')(default='txt', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'InteractionNode.type'
        raise RuntimeError("Cannot reverse this migration. 'InteractionNode.type' and its values cannot be restored.")

        # Deleting field 'InteractionNode.kind'
        db.delete_column('rb_interactionnode', 'kind')
