...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AllTag', fields ['node', 'group']
        db.create_unique(u'rb_alltag', ['node_id', 'group_id'])

        # Adding unique constraint on 'BlockedTag', fields ['node', 'group']
        db.create_unique(u'rb_blockedtag', ['node_id', 'group_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'BlockedTag', fields ['node', 'group']
        db.delete_unique(u'rb_blockedtag', ['node_id', 'group_id'])

        # Removing unique constraint on 'AllTag', fields ['node', 'group']
        db.delete_unique(u'rb_alltag', ['node_id', 'group_id'])
