...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialUser.img_url'
        db.alter_column('rb_socialuser', 'img_url', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'SocialUser.img_url'
        db.alter_column('rb_socialuser', 'img_url', self.gf('django.db.models.fields.URLField')(max_length=200))
