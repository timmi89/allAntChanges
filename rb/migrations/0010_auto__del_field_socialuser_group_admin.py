...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SocialUser.group_admin'
        db.delete_column('rb_socialuser', 'group_admin_id')

        # Adding M2M table for field admins on 'Group'
        db.create_table('rb_group_admins', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('group', models.ForeignKey(orm['rb.group'], null=False)),
            ('socialuser', models.ForeignKey(orm['rb.socialuser'], null=False))
        ))
        db.create_unique('rb_group_admins', ['group_id', 'socialuser_id'])


    def backwards(self, orm):
        
        # Adding field 'SocialUser.group_admin'
        db.add_column('rb_socialuser', 'group_admin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Group'], null=True, blank=True), keep_default=False)

        # Removing M2M table for field admins on 'Group'
        db.delete_table('rb_group_admins')
    ...
    models = {
        ...
        'rb.group': {
            ...
            'admins': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['rb.SocialUser']", 'symmetrical': 'False'}),
            ...
            'demonstration_group': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'rb.site': {
            ...
            'content_querystring': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
