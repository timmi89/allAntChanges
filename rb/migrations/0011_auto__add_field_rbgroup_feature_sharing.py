...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rb_rbgroup', 'feature_sharing', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rb.Feature']), keep_default=False)
    ...
    models = {
        ...
        'rb.rbgroup': {
            ...
            'feature_sharing': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['rb.Feature']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
