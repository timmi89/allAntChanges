...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.ignore_subdomain'
        db.add_column(u'rb_group', 'ignore_subdomain',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.ignore_subdomain'
        db.delete_column(u'rb_group', 'ignore_subdomain')
