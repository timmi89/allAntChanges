...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rb_nodevalue', (
            ...
            ('inode', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.InteractionNode'])),
    ...
    models = {
        ...
        'rb.nodevalue': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inode': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rb.InteractionNode']"}),
