...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('rb_lazyuser')

        # Deleting field 'Group.blessed_tags'
        db.delete_column('rb_group', 'blessed_tags')
    ...
    def backwards(self, orm):
        ...
        db.create_table('rb_lazyuser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal('rb', ['LazyUser'])

        # Adding field 'Group.blessed_tags'
        db.add_column('rb_group', 'blessed_tags', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)
