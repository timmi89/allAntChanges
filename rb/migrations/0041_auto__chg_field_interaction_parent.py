...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Interaction.parent'
        raise RuntimeError("Cannot reverse this migration. 'Interaction.parent' and its values cannot be restored.")
