...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RBGroup.feature_sharing'
        db.alter_column('rb_rbgroup', 'feature_sharing_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['rb.Feature'], unique=True))

        # Adding unique constraint on 'RBGroup', fields ['feature_sharing']
        db.create_unique('rb_rbgroup', ['feature_sharing_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'RBGroup', fields ['feature_sharing']
        db.delete_unique('rb_rbgroup', ['feature_sharing_id'])

        # Changing field 'RBGroup.feature_sharing'
        db.alter_column('rb_rbgroup', 'feature_sharing_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Feature']))
    ...
    models = {
        ...
        'rb.rbgroup': {
            ...
            'feature_sharing': ('django.db.models.fields.related.OneToOneField', [], {'default': '1', 'to': "orm['rb.Feature']", 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
