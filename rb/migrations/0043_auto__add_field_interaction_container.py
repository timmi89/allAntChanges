...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Interaction.container'
        db.add_column('rb_interaction', 'container', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Container'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Interaction.container'
        db.delete_column('rb_interaction', 'container_id')
