...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rb_contentnode', 'content_type', self.gf('django.db.models.fields.CharField')(default=1, max_length=3), keep_default=False)

        # Changing field 'ContentNode.type'
        db.alter_column('rb_contentnode', 'type', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    def backwards(self, orm):
        ...
        db.create_table('rb_tag', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', null=True, to=orm['rb.Tag'], blank=True)),
        ...
        db.create_table('rb_comment', (
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', null=True, to=orm['rb.Comment'], blank=True)),
            ('content', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('inserted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        ...
        db.delete_column('rb_contentnode', 'content_type')

        # Changing field 'ContentNode.type'
        db.alter_column('rb_contentnode', 'type', self.gf('django.db.models.fields.CharField')(max_length=3))
