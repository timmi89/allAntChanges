...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('rb_node', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='children', null=True, to=orm['rb.Node'], blank=True), keep_default=False)
