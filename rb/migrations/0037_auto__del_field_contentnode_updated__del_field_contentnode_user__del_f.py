...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ContentNode.user'
        db.delete_column('rb_contentnode', 'user_id')
        ...
        db.add_column('rb_contentnode', 'node_ptr', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['rb.Node'], unique=True, primary_key=True), keep_default=False)

        # Adding field 'ContentNode.content'
        db.add_column('rb_contentnode', 'content', self.gf('django.db.models.fields.TextField')(default=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ContentNode.user'
        raise RuntimeError("Cannot reverse this migration. 'ContentNode.user' and its values cannot be restored.")
