...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rb_edge', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Parents', to=orm['rb.Node'])),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Children', to=orm['rb.Node'])),
        ))
        db.send_create_signal('rb', ['Edge'])

        # Deleting field 'Node.parent'
        db.delete_column('rb_node', 'parent_id')

        # Deleting field 'Node.child'
        db.delete_column('rb_node', 'child_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column('rb_node', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Parent', null=True, to=orm['rb.Node'], blank=True), keep_default=False)

        # Adding field 'Node.child'
        db.add_column('rb_node', 'child', self.gf('django.db.models.fields.related.ForeignKey')(related_name='Child', null=True, to=orm['rb.Node'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'rb.edge': {
            ...
            'child': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Children'", 'to': "orm['rb.Node']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'Parents'", 'to': "orm['rb.Node']"})
        },
        'rb.feature': {
