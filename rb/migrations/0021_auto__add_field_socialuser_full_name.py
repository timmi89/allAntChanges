...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SocialUser.full_name'
        db.add_column('rb_socialuser', 'full_name', self.gf('django.db.models.fields.CharField')(default='Tyler Brock', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SocialUser.full_name'
        db.delete_column('rb_socialuser', 'full_name')
