...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'NodeValue', fields ['node', 'group', 'value']
        db.create_unique('rb_nodevalue', ['node_id', 'group_id', 'value'])

        # Adding unique constraint on 'InteractionNode', fields ['body', 'kind']
        db.create_unique('rb_interactionnode', ['body', 'kind'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'InteractionNode', fields ['body', 'kind']
        db.delete_unique('rb_interactionnode', ['body', 'kind'])

        # Removing unique constraint on 'NodeValue', fields ['node', 'group', 'value']
        db.delete_unique('rb_nodevalue', ['node_id', 'group_id', 'value'])
