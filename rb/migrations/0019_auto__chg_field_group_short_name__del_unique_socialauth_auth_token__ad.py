...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.short_name'
        db.alter_column('rb_group', 'short_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50))

        # Adding unique constraint on 'SocialAuth', fields ['social_user']
        db.create_unique('rb_socialauth', ['social_user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SocialAuth', fields ['social_user']
        db.delete_unique('rb_socialauth', ['social_user_id'])

        # Changing field 'Group.short_name'
        db.alter_column('rb_group', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))
    ...
    models = {
        ...
        'rb.group': {
            ...
            'css_url': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        'rb.socialauth': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'social_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'social_auth'", 'unique': 'True', 'to': "orm['rb.SocialUser']"})
        },
        'rb.socialuser': {
