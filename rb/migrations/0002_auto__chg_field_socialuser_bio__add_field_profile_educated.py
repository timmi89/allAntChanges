...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialUser.bio'
        db.alter_column('rb_socialuser', 'bio', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

        # Adding field 'Profile.educated'
        db.add_column('rb_profile', 'educated', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'SocialUser.bio'
        db.alter_column('rb_socialuser', 'bio', self.gf('django.db.models.fields.TextField')(default=''))

        # Deleting field 'Profile.educated'
        db.delete_column('rb_profile', 'educated')
