...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Interaction.interaction_node'
        db.add_column('rb_interaction', 'interaction_node', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rb.InteractionNode']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Interaction.interaction_node'
        db.delete_column('rb_interaction', 'interaction_node_id')
