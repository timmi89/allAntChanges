...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.paragraph_helper'
        db.add_column('rb_group', 'paragraph_helper', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.paragraph_helper'
        db.delete_column('rb_group', 'paragraph_helper')
