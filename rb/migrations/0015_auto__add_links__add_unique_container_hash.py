...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('rb', ['Links'])

        # Adding unique constraint on 'Container', fields ['hash']
        db.create_unique('rb_container', ['hash'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Container', fields ['hash']
        db.delete_unique('rb_container', ['hash'])

        # Deleting model 'Links'
        db.delete_table('rb_links')
