...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Group', fields ['rate']
        db.delete_unique('rb_group', ['rate_id'])

        # Removing unique constraint on 'Group', fields ['share']
        db.delete_unique('rb_group', ['share_id'])

        # Removing unique constraint on 'Group', fields ['bookmark']
        db.delete_unique('rb_group', ['bookmark_id'])

        # Removing unique constraint on 'Group', fields ['search']
        db.delete_unique('rb_group', ['search_id'])

        # Removing unique constraint on 'Group', fields ['comment']
        db.delete_unique('rb_group', ['comment_id'])

        # Changing field 'Group.comment'
        db.alter_column('rb_group', 'comment_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Feature']))

        # Changing field 'Group.search'
        db.alter_column('rb_group', 'search_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Feature']))

        # Changing field 'Group.bookmark'
        db.alter_column('rb_group', 'bookmark_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Feature']))

        # Changing field 'Group.share'
        db.alter_column('rb_group', 'share_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Feature']))

        # Changing field 'Group.rate'
        db.alter_column('rb_group', 'rate_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Feature']))


    def backwards(self, orm):
        
        # Changing field 'Group.comment'
        db.alter_column('rb_group', 'comment_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['rb.Feature']))

        # Adding unique constraint on 'Group', fields ['comment']
        db.create_unique('rb_group', ['comment_id'])

        # Changing field 'Group.search'
        db.alter_column('rb_group', 'search_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['rb.Feature']))

        # Adding unique constraint on 'Group', fields ['search']
        db.create_unique('rb_group', ['search_id'])

        # Changing field 'Group.bookmark'
        db.alter_column('rb_group', 'bookmark_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['rb.Feature']))

        # Adding unique constraint on 'Group', fields ['bookmark']
        db.create_unique('rb_group', ['bookmark_id'])

        # Changing field 'Group.share'
        db.alter_column('rb_group', 'share_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['rb.Feature']))

        # Adding unique constraint on 'Group', fields ['share']
        db.create_unique('rb_group', ['share_id'])

        # Changing field 'Group.rate'
        db.alter_column('rb_group', 'rate_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['rb.Feature']))

        # Adding unique constraint on 'Group', fields ['rate']
        db.create_unique('rb_group', ['rate_id'])
