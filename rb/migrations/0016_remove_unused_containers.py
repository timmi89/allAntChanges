...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        interactions = orm.Interaction.objects.all()
        container_ids = interactions.values('container')
        containers_to_remove = orm.Container.objects.exclude(id__in=container_ids)
        containers_to_remove.delete()
