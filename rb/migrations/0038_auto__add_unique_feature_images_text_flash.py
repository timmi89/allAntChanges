...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Feature', fields ['images', 'text', 'flash']
        db.create_unique('rb_feature', ['images', 'text', 'flash'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Feature', fields ['images', 'text', 'flash']
        db.delete_unique('rb_feature', ['images', 'text', 'flash'])
