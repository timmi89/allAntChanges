...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Follow.board'
        db.add_column('rb_follow', 'board', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='followed_board', null=True, to=orm['rb.Board']), keep_default=False)

        # Adding unique constraint on 'Board', fields ['title']
        db.create_unique('rb_board', ['title'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Board', fields ['title']
        db.delete_unique('rb_board', ['title'])

        # Deleting field 'Follow.board'
        db.delete_column('rb_follow', 'board_id')
