...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Content.type'
        db.delete_column('rb_content', 'type')

        # Adding field 'Content.kind'
        db.add_column('rb_content', 'kind', self.gf('django.db.models.fields.CharField')(default='txt', max_length=3), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Content.type'
        raise RuntimeError("Cannot reverse this migration. 'Content.type' and its values cannot be restored.")

        # Deleting field 'Content.kind'
        db.delete_column('rb_content', 'kind')
