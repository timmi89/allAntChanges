...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RBGroup.feature_sharing'
        db.add_column('rb_rbgroup', 'feature_sharing', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Feature'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RBGroup.feature_sharing'
        db.delete_column('rb_rbgroup', 'feature_sharing_id')
    ...
    models = {
        ...
        'rb.rbgroup': {
            ...
            'feature_sharing': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rb.Feature']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
