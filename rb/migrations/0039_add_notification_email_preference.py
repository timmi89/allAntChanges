...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SocialUser.notification_email_option'
        db.add_column('rb_socialuser', 'notification_email_option', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SocialUser.notification_email_option'
        db.delete_column('rb_socialuser', 'notification_email_option')
