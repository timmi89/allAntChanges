...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RBGroup.language'
        db.add_column('rb_rbgroup', 'language', self.gf('django.db.models.fields.CharField')(default='en', max_length=25), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'RBGroup.language'
        db.delete_column('rb_rbgroup', 'language')
