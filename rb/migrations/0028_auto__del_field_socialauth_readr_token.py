...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SocialAuth.readr_token'
        raise RuntimeError("Cannot reverse this migration. 'SocialAuth.readr_token' and its values cannot be restored.")
