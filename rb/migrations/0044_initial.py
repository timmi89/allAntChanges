...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rb_node', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Parent', null=True, to=orm['rb.Node'])),
            ('child', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='Child', null=True, to=orm['rb.Node'])),
        ))
