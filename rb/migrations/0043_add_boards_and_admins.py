...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BoardInteraction'
        db.create_table('rb_boardinteraction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('board', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Board'])),
            ('interaction', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Interaction'])),
        ))
        db.send_create_signal('rb', ['BoardInteraction'])

        # Adding unique constraint on 'BoardInteraction', fields ['board', 'interaction']
        db.create_unique('rb_boardinteraction', ['board_id', 'interaction_id'])

        # Adding model 'Board'
        db.create_table('rb_board', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='board_owner', to=orm['auth.User'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('visible', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('rb', ['Board'])

        # Adding unique constraint on 'Board', fields ['owner', 'title']
        db.create_unique('rb_board', ['owner_id', 'title'])

        # Adding model 'BoardAdmin'
        db.create_table('rb_boardadmin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('board', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rb.Board'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('approved', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('rb', ['BoardAdmin'])

        # Adding unique constraint on 'BoardAdmin', fields ['board', 'user']
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'BoardAdmin', fields ['board', 'user']
        db.delete_unique('rb_boardadmin', ['board_id', 'user_id'])

        # Removing unique constraint on 'Board', fields ['owner', 'title']
        db.delete_unique('rb_board', ['owner_id', 'title'])

        # Removing unique constraint on 'BoardInteraction', fields ['board', 'interaction']
        db.delete_unique('rb_boardinteraction', ['board_id', 'interaction_id'])

        # Deleting model 'BoardInteraction'
        db.delete_table('rb_boardinteraction')

        # Deleting model 'Board'
        db.delete_table('rb_board')

        # Deleting model 'BoardAdmin'
