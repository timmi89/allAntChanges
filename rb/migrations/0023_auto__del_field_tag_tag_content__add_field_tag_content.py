...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Tag.tag_content'
        db.delete_column('rb_tag', 'tag_content')

        # Adding field 'Tag.content'
        db.add_column('rb_tag', 'content', self.gf('django.db.models.fields.CharField')(default=1, max_length=160), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Tag.tag_content'
        raise RuntimeError("Cannot reverse this migration. 'Tag.tag_content' and its values cannot be restored.")
