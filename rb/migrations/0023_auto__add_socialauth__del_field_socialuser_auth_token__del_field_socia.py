...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('rb_socialauth', (
            ...
            ('expires', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'SocialUser.auth_token'
        raise RuntimeError("Cannot reverse this migration. 'SocialUser.auth_token' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'SocialUser.expires'
        raise RuntimeError("Cannot reverse this migration. 'SocialUser.expires' and its values cannot be restored.")
