...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.logo_url_sm'
        db.alter_column('rb_group', 'logo_url_sm', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Group.logo_url_lg'
        db.alter_column('rb_group', 'logo_url_lg', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'Group.logo_url_med'
        db.alter_column('rb_group', 'logo_url_med', self.gf('django.db.models.fields.CharField')(max_length=200))


    def backwards(self, orm):
        
        # Changing field 'Group.logo_url_sm'
        db.alter_column('rb_group', 'logo_url_sm', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Group.logo_url_lg'
        db.alter_column('rb_group', 'logo_url_lg', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Group.logo_url_med'
        db.alter_column('rb_group', 'logo_url_med', self.gf('django.db.models.fields.URLField')(max_length=200))
