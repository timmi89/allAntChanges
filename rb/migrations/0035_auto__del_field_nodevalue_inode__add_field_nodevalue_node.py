...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'NodeValue.inode'
        db.delete_column('rb_nodevalue', 'inode_id')

        # Adding field 'NodeValue.node'
        db.add_column('rb_nodevalue', 'node', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['rb.InteractionNode']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'NodeValue.inode'
        raise RuntimeError("Cannot reverse this migration. 'NodeValue.inode' and its values cannot be restored.")

        # Deleting field 'NodeValue.node'
        db.delete_column('rb_nodevalue', 'node_id')
