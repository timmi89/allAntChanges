...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rb_node', 'child', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='Child', to=orm['rb.Node']), keep_default=False)

        # Changing field 'Node.parent'
        db.alter_column('rb_node', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['rb.Node']))
