...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Follow', fields ['owner', 'type', 'follow_id']
        db.create_unique('rb_follow', ['owner_id', 'type', 'follow_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Follow', fields ['owner', 'type', 'follow_id']
        db.delete_unique('rb_follow', ['owner_id', 'type', 'follow_id'])

        # Deleting model 'Follow'
        db.delete_table('rb_follow')
