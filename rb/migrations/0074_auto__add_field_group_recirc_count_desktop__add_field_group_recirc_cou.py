...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.recirc_count_desktop'
        db.add_column(u'rb_group', 'recirc_count_desktop',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3),
                      keep_default=False)

        # Adding field 'Group.recirc_count_mobile'
        db.add_column(u'rb_group', 'recirc_count_mobile',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Group.recirc_rowcount_desktop'
        db.add_column(u'rb_group', 'recirc_rowcount_desktop',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3),
                      keep_default=False)

        # Adding field 'Group.recirc_rowcount_mobile'
        db.add_column(u'rb_group', 'recirc_rowcount_mobile',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Group.show_readmore'
        db.add_column(u'rb_group', 'show_readmore',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Group.readmore_label'
        db.add_column(u'rb_group', 'readmore_label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.readmore_selector'
        db.add_column(u'rb_group', 'readmore_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.readmore_crop_selector'
        db.add_column(u'rb_group', 'readmore_crop_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.readmore_crop_min'
        db.add_column(u'rb_group', 'readmore_crop_min',
                      self.gf('django.db.models.fields.IntegerField')(default=400, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.recirc_count_desktop'
        db.delete_column(u'rb_group', 'recirc_count_desktop')

        # Deleting field 'Group.recirc_count_mobile'
        db.delete_column(u'rb_group', 'recirc_count_mobile')

        # Deleting field 'Group.recirc_rowcount_desktop'
        db.delete_column(u'rb_group', 'recirc_rowcount_desktop')

        # Deleting field 'Group.recirc_rowcount_mobile'
        db.delete_column(u'rb_group', 'recirc_rowcount_mobile')

        # Deleting field 'Group.show_readmore'
        db.delete_column(u'rb_group', 'show_readmore')

        # Deleting field 'Group.readmore_label'
        db.delete_column(u'rb_group', 'readmore_label')

        # Deleting field 'Group.readmore_selector'
        db.delete_column(u'rb_group', 'readmore_selector')

        # Deleting field 'Group.readmore_crop_selector'
        db.delete_column(u'rb_group', 'readmore_crop_selector')

        # Deleting field 'Group.readmore_crop_min'
        db.delete_column(u'rb_group', 'readmore_crop_min')
    ...
    models = {
        ...
        u'rb.blockedpromotag': {
            'Meta': {'ordering': "['order']", 'unique_together': "(('group', 'node'),)", 'object_name': 'BlockedPromoTag'},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rb.Group']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'node': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['rb.InteractionNode']"}),
            'order': ('django.db.models.fields.IntegerField', [], {})
        ...
        u'rb.group': {
            ...
            'blocked_promo_tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'Blocked Promo Tag'", 'symmetrical': 'False', 'through': u"orm['rb.BlockedPromoTag']", 'to': u"orm['rb.InteractionNode']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ignore_subdomain': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'post_title_selector': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            ...
            'readmore_crop_min': ('django.db.models.fields.IntegerField', [], {'default': '400', 'max_length': '255'}),
            'readmore_crop_selector': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'readmore_label': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'readmore_selector': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'recirc_background': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'recirc_count_desktop': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '3'}),
            'recirc_count_mobile': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '2'}),
            'recirc_jquery_method': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'recirc_rowcount_desktop': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '3'}),
            'recirc_rowcount_mobile': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            ...
            'separate_cta_expanded': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '255', 'blank': 'True'}),
            ...
            'show_readmore': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'summary_widget_expanded_mobile': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'tag_box_bg_colors_hover': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'word_whitelist': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        u'rb.groupadmin': {
        ...
        u'rb.interaction': {
            ...
            'promotable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
