...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.post_title_selector'
        db.add_column(u'rb_group', 'post_title_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.post_title_selector'
        db.delete_column(u'rb_group', 'post_title_selector')
