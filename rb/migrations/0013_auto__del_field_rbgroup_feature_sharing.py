...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('rb_rbgroup', 'feature_sharing', self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['rb.Feature'], unique=True), keep_default=False)
