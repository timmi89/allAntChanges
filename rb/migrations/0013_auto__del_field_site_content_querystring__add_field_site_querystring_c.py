...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.querystring_content'
        db.add_column('rb_site', 'querystring_content', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Site.querystring_content'
        db.delete_column('rb_site', 'querystring_content')
