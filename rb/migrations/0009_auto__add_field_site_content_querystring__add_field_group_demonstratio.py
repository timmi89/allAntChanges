...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.content_querystring'
        db.add_column('rb_site', 'content_querystring', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Group.demonstration_group'
        db.add_column('rb_group', 'demonstration_group', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Site.content_querystring'
        db.delete_column('rb_site', 'content_querystring')

        # Deleting field 'Group.demonstration_group'
        db.delete_column('rb_group', 'demonstration_group')
