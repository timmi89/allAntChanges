...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BlockedPromoTag'
        db.create_table('rb_blockedpromotag', (
        ...
        db.send_create_signal('rb', ['BlockedPromoTag'])

        # Adding unique constraint on 'BlockedPromoTag', fields ['group', 'node']
        db.create_unique('rb_blockedpromotag', ['group_id', 'node_id'])

        # Adding field 'Interaction.promotable'
        db.add_column('rb_interaction', 'promotable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Group.activated'
        db.add_column('rb_group', 'activated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Group.recirc_background'
        db.add_column('rb_group', 'recirc_background',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Group.recirc_jquery_method'
        db.add_column('rb_group', 'recirc_jquery_method',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'BlockedPromoTag', fields ['group', 'node']
        db.delete_unique('rb_blockedpromotag', ['group_id', 'node_id'])

        # Deleting model 'BlockedPromoTag'
        db.delete_table('rb_blockedpromotag')

        # Deleting field 'Interaction.promotable'
        db.delete_column('rb_interaction', 'promotable')

        # Deleting field 'Group.activated'
        db.delete_column('rb_group', 'activated')

        # Deleting field 'Group.recirc_background'
        db.delete_column('rb_group', 'recirc_background')

        # Deleting field 'Group.recirc_jquery_method'
        db.delete_column('rb_group', 'recirc_jquery_method')
    ...
    models = {
        ...
        'rb.group': {
            ...
            'blocked_promo_tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'Blocked Promo Tag'", 'symmetrical': 'False', 'through': "orm['rb.BlockedPromoTag']", 'to': "orm['rb.InteractionNode']"}),
