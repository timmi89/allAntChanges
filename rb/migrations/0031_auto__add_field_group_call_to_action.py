...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.call_to_action'
        db.add_column('rb_group', 'call_to_action', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.call_to_action'
        db.delete_column('rb_group', 'call_to_action')
