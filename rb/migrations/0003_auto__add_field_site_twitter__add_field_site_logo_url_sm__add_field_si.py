...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Site.twitter'
        db.add_column('rb_site', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)

        # Adding field 'Site.logo_url_sm'
        db.add_column('rb_site', 'logo_url_sm', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Site.logo_url_med'
        db.add_column('rb_site', 'logo_url_med', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Site.logo_url_lg'
        db.add_column('rb_site', 'logo_url_lg', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding unique constraint on 'InteractionNode', fields ['body']
        db.create_unique('rb_interactionnode', ['body'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'InteractionNode', fields ['body']
        db.delete_unique('rb_interactionnode', ['body'])

        # Deleting field 'Site.twitter'
        db.delete_column('rb_site', 'twitter')

        # Deleting field 'Site.logo_url_sm'
        db.delete_column('rb_site', 'logo_url_sm')

        # Deleting field 'Site.logo_url_med'
        db.delete_column('rb_site', 'logo_url_med')

        # Deleting field 'Site.logo_url_lg'
        db.delete_column('rb_site', 'logo_url_lg')
