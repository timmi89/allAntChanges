...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'SocialUser', fields ['uid', 'provider']
        db.delete_unique('rb_socialuser', ['uid', 'provider'])

        # Removing unique constraint on 'SocialUser', fields ['username']
        db.delete_unique('rb_socialuser', ['username'])

        # Adding unique constraint on 'SocialUser', fields ['username', 'uid', 'provider']
        db.create_unique('rb_socialuser', ['username', 'uid', 'provider'])

    def backwards(self, orm):
        # Removing unique constraint on 'SocialUser', fields ['username', 'uid', 'provider']
        db.delete_unique('rb_socialuser', ['username', 'uid', 'provider'])

        # Adding unique constraint on 'SocialUser', fields ['username']
        db.create_unique('rb_socialuser', ['username'])

        # Adding unique constraint on 'SocialUser', fields ['uid', 'provider']
        db.create_unique('rb_socialuser', ['uid', 'provider'])
