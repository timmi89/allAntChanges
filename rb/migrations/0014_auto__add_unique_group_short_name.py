...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Group', fields ['short_name']
        db.create_unique('rb_group', ['short_name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Group', fields ['short_name']
        db.delete_unique('rb_group', ['short_name'])
