...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.twitter'
        db.add_column('rb_group', 'twitter', self.gf('django.db.models.fields.CharField')(default='', max_length=64, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.twitter'
        db.delete_column('rb_group', 'twitter')
