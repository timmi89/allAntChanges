...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SocialUser.username'
        db.add_column('rb_socialuser', 'username', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SocialUser.username'
        db.delete_column('rb_socialuser', 'username')
