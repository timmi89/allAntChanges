...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GroupBlessedTags'
        db.create_table('rb_groupblessedtags', (
        ...
        db.send_create_signal('rb', ['GroupBlessedTags'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GroupBlessedTags'
        db.delete_table('rb_groupblessedtags')
    ...
    models = {
        ...
        'rb.group': {
            ...
            'blessed_tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['rb.InteractionNode']", 'through': "orm['rb.GroupBlessedTags']", 'symmetrical': 'False'}),
        ...
        'rb.groupblessedtags': {
            'Meta': {'ordering': "['order']", 'object_name': 'GroupBlessedTags'},
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rb.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
