...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.show_recirc'
        db.add_column(u'rb_group', 'show_recirc',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Group.recirc_selector'
        db.add_column(u'rb_group', 'recirc_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.recirc_title'
        db.add_column(u'rb_group', 'recirc_title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.show_recirc'
        db.delete_column(u'rb_group', 'show_recirc')

        # Deleting field 'Group.recirc_selector'
        db.delete_column(u'rb_group', 'recirc_selector')

        # Deleting field 'Group.recirc_title'
        db.delete_column(u'rb_group', 'recirc_title')
