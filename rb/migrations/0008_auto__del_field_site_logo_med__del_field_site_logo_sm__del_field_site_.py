...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site.logo_med'
        db.delete_column('rb_site', 'logo_med')

        # Deleting field 'Site.logo_sm'
        db.delete_column('rb_site', 'logo_sm')

        # Deleting field 'Site.logo_lg'
        db.delete_column('rb_site', 'logo_lg')

        # Deleting field 'Group.logo_sm'
        db.delete_column('rb_group', 'logo_sm')

        # Deleting field 'Group.logo_med'
        db.delete_column('rb_group', 'logo_med')

        # Deleting field 'Group.logo_lg'
        db.delete_column('rb_group', 'logo_lg')

        # Adding field 'Group.post_selector'
        db.add_column('rb_group', 'post_selector', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Group.post_href_selector'
        db.add_column('rb_group', 'post_href_selector', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Group.summary_widget_selector'
        db.add_column('rb_group', 'summary_widget_selector', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Site.logo_med'
        db.add_column('rb_site', 'logo_med', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Site.logo_sm'
        db.add_column('rb_site', 'logo_sm', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Site.logo_lg'
        db.add_column('rb_site', 'logo_lg', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Group.logo_sm'
        db.add_column('rb_group', 'logo_sm', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Group.logo_med'
        db.add_column('rb_group', 'logo_med', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Group.logo_lg'
        db.add_column('rb_group', 'logo_lg', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Group.post_selector'
        db.delete_column('rb_group', 'post_selector')

        # Deleting field 'Group.post_href_selector'
        db.delete_column('rb_group', 'post_href_selector')

        # Deleting field 'Group.summary_widget_selector'
        db.delete_column('rb_group', 'summary_widget_selector')
