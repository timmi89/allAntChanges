...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('rb_contentnode', 'type')
    ...
    def backwards(self, orm):
        ...
        db.add_column('rb_contentnode', 'content', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'ContentNode.type'
        raise RuntimeError("Cannot reverse this migration. 'ContentNode.type' and its values cannot be restored.")
