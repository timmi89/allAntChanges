...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.br_replace_scope_selector'
        db.add_column(u'rb_group', 'br_replace_scope_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.br_replace_scope_selector'
        db.delete_column(u'rb_group', 'br_replace_scope_selector')
    ...
    models = {
        ...
        u'rb.group': {
            ...
            'blessed_tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['rb.InteractionNode']", 'through': u"orm['rb.GroupBlessedTag']", 'symmetrical': 'False'}),
