...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('rb_node', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rb.Node']))

        # Changing field 'Node.child'
        db.alter_column('rb_node', 'child_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['rb.Node']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Node.parent'
        raise RuntimeError("Cannot reverse this migration. 'Node.parent' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Node.child'
        raise RuntimeError("Cannot reverse this migration. 'Node.child' and its values cannot be restored.")
    ...
    models = {
        ...
        'rb.node': {
            ...
            'child': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Child'", 'null': 'True', 'to': "orm['rb.Node']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inserted': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'Parent'", 'null': 'True', 'to': "orm['rb.Node']"}),
