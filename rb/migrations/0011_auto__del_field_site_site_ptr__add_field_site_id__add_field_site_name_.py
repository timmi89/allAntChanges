...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Site.site_ptr'
        db.delete_column('rb_site', 'site_ptr_id')

        # Adding field 'Site.id'
        db.add_column('rb_site', 'id', self.gf('django.db.models.fields.AutoField')(default=1, primary_key=True), keep_default=False)

        # Adding field 'Site.name'
        db.add_column('rb_site', 'name', self.gf('django.db.models.fields.CharField')(default=1, max_length=100), keep_default=False)

        # Adding field 'Site.domain'
        db.add_column('rb_site', 'domain', self.gf('django.db.models.fields.CharField')(default=1, max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Site.site_ptr'
        raise RuntimeError("Cannot reverse this migration. 'Site.site_ptr' and its values cannot be restored.")

        # Deleting field 'Site.id'
        db.delete_column('rb_site', 'id')

        # Deleting field 'Site.name'
        db.delete_column('rb_site', 'name')

        # Deleting field 'Site.domain'
        db.delete_column('rb_site', 'domain')
