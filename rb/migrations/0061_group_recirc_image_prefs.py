...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Group.image_selector'
        db.add_column(u'rb_group', 'image_selector',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Group.image_attribute'
        db.add_column(u'rb_group', 'image_attribute',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Page.image'
        db.add_column(u'rb_page', 'image',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Group.image_selector'
        db.delete_column(u'rb_group', 'image_selector')

        # Deleting field 'Group.image_attribute'
        db.delete_column(u'rb_group', 'image_attribute')

        # Deleting field 'Page.image'
        db.delete_column(u'rb_page', 'image')
