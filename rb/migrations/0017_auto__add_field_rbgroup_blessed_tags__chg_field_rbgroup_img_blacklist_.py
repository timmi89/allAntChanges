...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RBGroup.blessed_tags'
        db.add_column('rb_rbgroup', 'blessed_tags', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)

        # Changing field 'RBGroup.img_blacklist'
        db.alter_column('rb_rbgroup', 'img_blacklist', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'RBGroup.anno_whitelist'
        db.alter_column('rb_rbgroup', 'anno_whitelist', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'RBGroup.no_readr'
        db.alter_column('rb_rbgroup', 'no_readr', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'RBGroup.img_whitelist'
        db.alter_column('rb_rbgroup', 'img_whitelist', self.gf('django.db.models.fields.CharField')(max_length=250))


    def backwards(self, orm):
        
        # Deleting field 'RBGroup.blessed_tags'
        db.delete_column('rb_rbgroup', 'blessed_tags')

        # Changing field 'RBGroup.img_blacklist'
        db.alter_column('rb_rbgroup', 'img_blacklist', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'RBGroup.anno_whitelist'
        db.alter_column('rb_rbgroup', 'anno_whitelist', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'RBGroup.no_readr'
        db.alter_column('rb_rbgroup', 'no_readr', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'RBGroup.img_whitelist'
        db.alter_column('rb_rbgroup', 'img_whitelist', self.gf('django.db.models.fields.CharField')(max_length=100))
