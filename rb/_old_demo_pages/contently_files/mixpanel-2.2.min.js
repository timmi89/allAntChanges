...
screen.width).toString(16);return b()+"-"+Math.random().toString(16).replace(".","")+"-"+a()+"-"+c+"-"+b()}}();c.Oa=function(){return/(google web preview|baiduspider|yandexbot)/i.test(n)?o:v};c.va=function(a){var b,e,g,d=[];"undefined"===typeof b&&(b="&");c.a(a,function(a,b){e=encodeURIComponent(a.toString());g=encodeURIComponent(b);d[d.length]=g+"="+e});return d.join(b)};c.ga=function(a,b){var b=b.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]"),c=RegExp("[\\?&]"+b+"=([^&#]*)").exec(a);return c===q||
...
function(e){a=c.ga(r.URL,e);a.length&&(b[e]=a)});return b},Va:function(a){return 0===a.search("https?://(.*)google.([^/?]*)")?"google":0===a.search("https?://(.*)bing.com")?"bing":0===a.search("https?://(.*)yahoo.com")?"yahoo":0===a.search("https?://(.*)duckduckgo.com")?"duckduckgo":q},Wa:function(a){var b=c.info.Va(a),e={};if(b!==q)e.$search_engine=b,a=c.ga(a,"yahoo"!=b?"q":"p"),a.length&&(e.mp_keyword=a);return e},R:function(){var a=M.vendor||"";return window.opera?c.h(n,"Mini")?"Opera Mini":"Opera":
...
function(a){u.error(a)})}}}};w.prototype.w=C();w.prototype.U=C();w.prototype.Q=C();w.prototype.X=function(a){this.la=a;return this};w.prototype.l=function(a,b,e,g){var d=this,j=c.Ha(a);if(0==j.length)s.error("The DOM query ("+a+") returned 0 elements");else return c.a(j,function(a){c.pa(a,this.na,function(a){var c={},i=d.w(e,this),j=d.la.d("track_links_timeout");d.U(a,this,c);window.setTimeout(d.ra(g,i,c,o),j);d.la.l(b,i,d.ra(g,i,c))})},this),o};w.prototype.ra=function(a,b,c,g){var g=g||v,d=this;
...
this.K(a),g=b[a],d=this.J("$set"),j=this.J("$add"),i=this.J("$append",[]);"__mps"===e?(c.extend(d,g),this.N("$add",g)):"__mpa"===e?c.a(g,function(a,b){b in d?d[b]+=a:(b in j||(j[b]=0),j[b]+=a)},this):"__mpap"===e&&i.push(g);s.log("MIXPANEL PEOPLE REQUEST (QUEUED, PENDING IDENTIFY):");s.log(b);this.save()};k.prototype.N=function(a,b){var e=this.v(a);c.e(e)||(c.a(b,function(a,b){delete e[b]},this),this.save())};k.prototype.K=function(a){if("$set"===a)return"__mps";if("$add"===a)return"__mpa";if("$append"===
...
else{var g=this.d("verbose");this.d("test")&&(b.test=1);g&&(b.verbose=1);this.d("img")&&(b.img=1);e&&!H&&(b.callback=e);b.ip=this.d("ip")?1:0;b._=(new Date).getTime().toString();a+="?"+c.va(b);if("img"in b){var d=r.createElement("img");d.src=a;r.body.appendChild(d)}else if(H){var f=new XMLHttpRequest;f.open("GET",a,o);f.withCredentials=o;f.onreadystatechange=function(){if(4===f.readyState)if(200===f.status)e&&(g?e(c.D(f.responseText)):e(Number(f.responseText)));else{var a="Bad HTTP status: "+f.status+
" "+f.statusText;s.error(a);e&&(g?e({status:0,error:a}):e(0))}};f.send(q)}else{d=r.createElement("script");d.type="text/javascript";d.async=o;d.defer=o;d.src=a;var i=r.getElementsByTagName("script")[0];i.parentNode.insertBefore(d,i)}}};f.prototype.I=function(a){function b(a,b){c.a(a,function(a){this[a[0]].apply(this,a.slice(1))},b)}var e,g=[],d=[],f=[];c.a(a,function(a){a&&(e=a[0],"function"===typeof a?a.call(this):c.isArray(a)&&"alias"===e?g.push(a):c.isArray(a)&&-1!=e.indexOf("track")&&"function"===
typeof this[e]?f.push(a):d.push(a))},this);b(g,this);b(d,this);b(f,this)};f.prototype.push=function(a){this.I([a])};f.prototype.disable=function(a){"undefined"===typeof a?this.s.Ga=o:this.F=this.F.concat(a)};f.prototype.l=function(a,b,e){if("undefined"===typeof a)s.error("No event name provided to mixpanel.track");else if(c.Oa()||this.s.Ga||c.ha(this.F,a))"undefined"!==typeof e&&e(0);else return b=b||{},b.token=b.jb||this.d("token"),this.cookie.ua(r.referrer),this.d("store_google")&&this.cookie.cb(),
this.d("save_referrer")&&this.cookie.$(r.referrer),b=c.extend({},c.info.A(),this.cookie.A(),b),a=c.truncate({event:a,properties:b},255),b=c.q(a),b=c.ca(b),s.log("MIXPANEL REQUEST:"),s.log(a),this.i(this.d("api_host")+"/track/",{data:b},this.ba(e,a)),a};f.prototype.sa=function(a){if("undefined"===typeof a)a=r.location.href;this.l("mp_page_view",c.info.Ta(a))};f.prototype.bb=function(){return this.P.call(this,B,arguments)};f.prototype.ab=function(){return this.P.call(this,F,arguments)};f.prototype.o=
function(a,b){this.cookie.o(a,b)};f.prototype.j=function(a,b,c){this.cookie.j(a,b,c)};f.prototype.C=function(a){this.cookie.C(a)};f.prototype.O=function(a,b){var c={};c[a]=b;this.o(c)};f.prototype.W=function(a,b,c,g){a!=this.m()&&a!=this.z("__alias")&&(this.C("__alias"),this.O("distinct_id",a));this.s.Ma=o;this.people.za(b,c,g)};f.prototype.m=function(){return this.z("distinct_id")};f.prototype.Aa=function(a,b){if(a===this.z("$people_distinct_id"))return s.S("Attempting to create alias for existing People user - aborting."),
...
f.prototype.toString=function(){var a=this.d("name");"mixpanel"!==a&&(a="mixpanel."+a);return a};l.prototype.L=function(a){this.c=a};l.prototype.set=function(a,b,e){var g={},d={};c.g(a)?(c.a(a,function(a,b){"$distinct_id"==b||"$token"==b||(d[b]=a)}),e=b):d[a]=b;this.u("save_referrer")&&this.c.cookie.$(r.referrer);d=c.extend({},c.info.Ua(),this.c.cookie.La(),d);g.$set=d;return this.i(g,e)};l.prototype.ia=function(a,b,e){var g={},d={};c.g(a)?(c.a(a,function(a,b){"$distinct_id"==b||"$token"==b||(isNaN(parseFloat(a))?
s.error("Invalid increment value passed to mixpanel.people.increment - must be a number"):d[b]=a)}),e=b):(c.e(b)&&(b=1),d[a]=b);g.$add=d;return this.i(g,e)};l.prototype.append=function(a,b,e){var g={},d={};c.g(a)?(c.a(a,function(a,b){"$distinct_id"==b||"$token"==b||(d[b]=a)}),e=b):d[a]=b;g.$append=d;return this.i(g,e)};l.prototype.$a=function(a,b,e){if(!c.Ra(a)&&(a=parseFloat(a),isNaN(a))){s.error("Invalid value passed to mixpanel.people.track_charge - must be a number");return}return this.append("$transactions",
c.extend({$amount:a},b),e)};l.prototype.Da=function(a){return this.set("$transactions",[],a)};l.prototype.Ea=function(){if(this.aa())return this.i({$delete:this.c.m()});s.error("mixpanel.people.delete_user() requires you to call identify() first")};l.prototype.toString=function(){return this.c.toString()+".people"};l.prototype.i=function(a,b){a.$token=this.u("token");a.$distinct_id=this.c.m();var e=c.fa(a),g=c.truncate(e,255),e=c.q(e),e=c.ca(e);if(!this.aa())return this.ya(a),c.e(b)||(this.u("verbose")?
b({status:-1,error:q}):b(-1)),g;s.log("MIXPANEL PEOPLE REQUEST:");s.log(g);this.c.i(this.u("api_host")+"/engage/",{data:e},this.c.ba(b,g));return g};l.prototype.u=function(a){return this.c.d(a)};l.prototype.aa=function(){return this.c.s.Ma===o};l.prototype.ya=function(a){"$set"in a?this.c.cookie.k("$set",a):"$add"in a?this.c.cookie.k("$add",a):"$append"in a?this.c.cookie.k("$append",a):s.error("Invalid call to _enqueue():",a)};l.prototype.za=function(a,b,e){var g=this,d=c.extend({},this.c.cookie.v("$set")),
f=c.extend({},this.c.cookie.v("$add")),i=this.c.cookie.v("$append");!c.e(d)&&c.g(d)&&!c.Y(d)&&(g.c.cookie.N("$set",d),this.set(d,function(b,e){0==b&&g.c.cookie.k("$set",d);c.e(a)||a(b,e)}));!c.e(f)&&c.g(f)&&!c.Y(f)&&(g.c.cookie.N("$add",f),this.ia(f,function(a,d){0==a&&g.c.cookie.k("$add",f);c.e(b)||b(a,d)}));if(!c.e(i)&&c.isArray(i)&&i.length)for(var h=i.length-1;0<=h;h--){var k=i.pop();g.append(k,function(a,b){0==a&&g.c.cookie.k("$append",k);c.e(e)||e(a,b)})}};c.toArray=c.p;c.isObject=c.g;c.JSONEncode=
c.q;c.JSONDecode=c.D;c.isEmptyObject=c.Y;f.prototype.init=f.prototype.X;f.prototype.disable=f.prototype.disable;f.prototype.track=f.prototype.l;f.prototype.track_links=f.prototype.bb;f.prototype.track_forms=f.prototype.ab;f.prototype.track_pageview=f.prototype.sa;f.prototype.register=f.prototype.o;f.prototype.register_once=f.prototype.j;f.prototype.unregister=f.prototype.C;f.prototype.identify=f.prototype.W;f.prototype.alias=f.prototype.Aa;f.prototype.name_tag=f.prototype.Sa;f.prototype.set_config=
f.prototype.qa;f.prototype.get_config=f.prototype.d;f.prototype.get_property=f.prototype.z;f.prototype.get_distinct_id=f.prototype.m;f.prototype.toString=f.prototype.toString;k.prototype.properties=k.prototype.A;k.prototype.update_search_keyword=k.prototype.ua;k.prototype.update_referrer_info=k.prototype.$;k.prototype.get_cross_subdomain=k.prototype.Ka;k.prototype.clear=k.prototype.clear;l.prototype.set=l.prototype.set;l.prototype.increment=l.prototype.ia;l.prototype.append=l.prototype.append;l.prototype.track_charge=
l.prototype.$a;l.prototype.clear_charges=l.prototype.Da;l.prototype.delete_user=l.prototype.Ea;l.prototype.toString=l.prototype.toString;if(c.e(t))s.S("'mixpanel' object not initialized. Ensure you are using the latest version of the Mixpanel JS Library along with the snippet we provide.");else if(t.__loaded||t.config&&t.cookie)s.error("Mixpanel library has already been downloaded at least once.");else if(1.1>z)s.S("Version mismatch; please ensure you're using the latest version of the Mixpanel code snippet.");
