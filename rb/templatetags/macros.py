...
3) Use the macro with a string parameters or context variables::
    {% usemacro test2args1kwarg "foo" "bar" baz="KW" %}
    <br>
    {% usemacro test2args1kwarg num_pages "bar" %}
    <br>
    {% usemacro test2args1kwarg %}
    <br>
    {% usemacro test2args1kwarg "new" "foobar"|join:"," baz="diff kwarg" %}
    renders like
    foo bar KW
    77 bar Default baz
