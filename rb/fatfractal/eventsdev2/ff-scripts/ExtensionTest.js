...
function ExtensionTest(json) {
    ...
    testObject.totalMatchingPages = ff.getArrayFromUri("/PagesTest/(url eq '" + data.httpContent.pageUrl + "')").length;
    testObject.matchingPages = ff.getArrayFromUri("/PagesTest/(url eq '" + data.httpContent.pageUrl + "')");
