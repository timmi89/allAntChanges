...
},{"./call-to-action-counter":4,"./call-to-action-expanded-reactions":5,"./call-to-action-label":7,"./reactions-widget":27,"./utils/touch-support":54}],7:[function(require,module,exports){
var Ractive; require('./utils/ractive-provider').onLoad(function(loadedRactive) { Ractive = loadedRactive;});
...
},{"../templates/media-indicator-widget.hbs.html":75,"./reactions-widget":27,"./svgs":31,"./utils/app-mode":36,"./utils/browser-metrics":37,"./utils/jquery-provider":40,"./utils/mutation-observer":46,"./utils/ractive-provider":49,"./utils/throttled-events":53,"./utils/touch-support":54}],21:[function(require,module,exports){
var $; require('./utils/jquery-provider').onLoad(function(jQuery) { $=jQuery; });
var AjaxClient = require('./utils/ajax-client');
