...
},{"./utils/ajax-client":38,"./utils/browser-metrics":40,"./utils/segment":59,"./utils/session-data":60,"./utils/user":67}],16:[function(require,module,exports){
var Ractive; require('./utils/ractive-provider').onLoad(function(loadedRactive) { Ractive = loadedRactive;});
var SVGs = require('./svgs');
...
},{"../templates/text-indicator-widget.hbs.html":102,"./popup-widget":27,"./reactions-widget":29,"./svgs":34,"./utils/jquery-provider":43,"./utils/ractive-provider":55,"./utils/range":56,"./utils/touch-support":62}],37:[function(require,module,exports){
var $; require('./utils/jquery-provider').onLoad(function(jQuery) { $=jQuery; });
var PopupWidget = require('./popup-widget');
var Range = require('./utils/range');
var ReactionsWidget = require('./reactions-widget');
...
},{"./app-mode":39,"./jquery-provider":43,"./url-constants":64,"./widget-bucket":69}],72:[function(require,module,exports){
