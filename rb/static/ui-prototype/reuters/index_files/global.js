  ...
  if (!top.__nbcudigitaladops){
	var __nbcudigitaladops = {
		init : function(){
			...
			document.write('<scr'+'ipt src="http://www.nbcudigitaladops.com/hosted/js/'+site+'_header.js"></scr'+'ipt>');

			document.write('<scr'+'ipt src="http://www.nbcudigitaladops.com/hosted/js/'+site+'.js"></scr'+'ipt>');
		},
		dtprm : function(p){
			if(p==''||p==undefined){
				return false;
