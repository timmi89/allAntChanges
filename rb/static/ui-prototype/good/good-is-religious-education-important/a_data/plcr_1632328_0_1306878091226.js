              ...
              function PlacementCreative_1306878091273(creative) {
                ...
                this.exitEvents["Background Clickthrough"] = {
                    reportingId: 574295,
                    url: this.replaceMacros("http://www.fuelinggood.com?cmpid=%ebuy!|%esid!|%epid!|%ecid!", creative),
                ...
                for(var assetName in this.childAssets) {
                  if (!core.isPartOfArrayPrototype(assetName)) {
                    ...
                    if(!asset.isHostedByCdn) {
                      var fileUrl = creative.mediaServer + "/3149779/" + asset.cdnName;
               ...
               function InPage_1306878091273(creative, type) {
                  this.variableName = "0_1_" + (new Date()).getTime();
                  this.url = creative.mediaServer + "/3149779/PID_1632328_CIT_FG11_odometer_300x600.swf";
                  this.altText = "";
                  this.width = "300";
                  this.height = "600";
                  this.wmode = "opaque";
              ...
              function InPageHTML_1306878091273(creative, type) {
                  this.variableName = "0__" + (new Date()).getTime();
                  this.url = creative.mediaServer + "/3149779/";
                  this.altText = "";
                  this.width = "";
                  this.height = "";
                  this.assetType = type;
              ...
              var baseCreative = new RichMediaCreative_1306878091273(core.CREATIVE_TYPE_INPAGE);
              var creative = new PlacementCreative_1306878091273(baseCreative);
              var isFlashAssetExist = true;
              if(creative.shouldDisplayFlashAsset) {
                creative.assets[core.ASSET_TYPE_INPAGE] = new InPage_1306878091273(creative, core.ASSET_TYPE_INPAGE);
              ...
              if(creative.forceHTML5Creative || creative.isHTML5PreviewMode || !creative.shouldDisplayFlashAsset || !isFlashAssetExist) {
                ...
                creative.assets[core.ASSET_TYPE_INPAGE] = new InPageHTML_1306878091273(creative, core.ASSET_TYPE_INPAGE);
              }
