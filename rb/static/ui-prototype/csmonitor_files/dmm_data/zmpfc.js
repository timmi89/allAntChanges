...
zzNewCke['FFAbh']=(typeof(zxCke['FFAbh'])!='undefined')?zxCke['FFAbh']:"";
zzNewCke['FFbh']=(typeof(zxCke['FFbh'])!='undefined')?zxCke['FFbh']:"";
zzNewCke['ZFFAbh']=(typeof(zxCke['ZFFAbh'])!='undefined')?zxCke['ZFFAbh']:"";
zzNewCke['ZFFbh']=(typeof(zxCke['ZFFbh'])!='undefined')?zxCke['ZFFbh']:"";
zzNewCke['DFFAbh']=(typeof(zxCke['DFFAbh'])!='undefined')?zxCke['DFFAbh']:"";
zzNewCke['DFFbh']=(typeof(zxCke['DFFbh'])!='undefined')?zxCke['DFFbh']:"";
...
if(zcy0.length==0){
if(zzNewEsi==false){
zcy0=zCF0('FFChanCap',true);
}else{
zcy0=zzNewCke['FFChanCap'];
}}
...
if(typeof(zca0[1])=='undefined')zca0[1]=1;
...
if(zzNewEsi==true){
document.write('<script language="javascript" src="http://d7.zedo.com/OzoDB/cutils/R53_5/jsc/1099//egc.js?&x=1&n='+zce0+'&c='+zcc1+'&a='+zcq2+'&d='+zcr0+'&z='+Math.random()+'"></script>');
}else{
...
var zci1='';var zcn0=zCF1(zcp2,zcr0);var zcq3=zCB0(zcp2);
if(zcn0>99){
zcc2=true;
}
if(zco3>-1){
...
var zcd1=zcw0[zl_id].getPositions().split(',');var zcz0=zco0[zcd1[1]-i].split(',');
if(zcz0[1]<zcq3){
...
zcd4=zCU2(zcp2,zci0,zco0);
}
}else{
var zcn1=zCU0();
zcd4=zcn1+'B'+zce0+','+zcc1+'#'+zcq2+'|'+'0,'+zCF1(zcn1,zcr0)+','+zcr0;
}
if(zcd4.length>=3000){
zCU3('FFChanCap',zcd4);
}else{
...
document.cookie='FFChanCap='+zcd4+';expires='+zcw3.toUTCString()+';path=/;domain=.zedo.com';
}
zCF2();
zzInitFc(zce0,zcc1);
}}
...
if(zzNewEsi==true){
document.write('<script language="javascript" src="http://d7.zedo.com/OzoDB/cutils/R53_5/jsc/1099//egc.js?&x=0&n='+zce0+'&f='+zcx3+'&d='+zcr0+'&z='+Math.random()+'"></script>');
}else{
...
var zcn0=zCF1(zcp2,zcr0);var zcq3=zCB0(zcp2);
if(zcn0>99){
zcc2=true;
}
if(zce3>-1){
...
var zcd1=zcv0[zl_id].getPositions().split(',');var zcz0=zco0[zcd1[1]-i].split(',');
if(zcz0[1]<zcq3){
...
zcx0=zCB6(zcp2,zci0,zco0);
}
}else{
var zcn1=zCU0();
zcx0=zcn1+'B'+zce0+','+zcx3+'|'+'0,'+zCF1(zcn1,zcr0)+','+zcr0;
}
if(zcx0.length>=3000){
zCU3('FFCap',zcx0);
}else{
var zcw3=new Date();
zcw3.setTime(zcw3.getTime()+(60 * 60 * 1000 * 24 * 30));
document.cookie='FFCap='+zcx0+';expires='+zcw3.toUTCString()+';path=/;domain=.zedo.com';
}
zCF2();
zzInitFc(zce0,-1);
}}
...
if(Math.floor(zzsrand * zcr5)<Math.floor(zcz5 /((zcr0==0)?1:zcr0))){
return false;
}else{
return true;
}}
...
var zcd6=zCU1(zce0,zca1,zcr0,'FFCap');
if((!zcd6&&parseInt(zcv0[zca1].getCapValue())<zcz5-1)
||zcd6){
return false;
}
return true;
...
var zcd6=zCU1(zcz1,zci1,zcr0,'FFChanCap');
...
zce8.src='http://r1.zedo.com/log/ERR.gif?v=OzoDB/cutils/R53_5/jsc/1099/;'+zcp3+'b='+navigator.userAgent;
}}
function zCU0(){
var zcq5=new Date();
...
var zco13=zCB0(zcp4);var zcn0=zco13+zci12-1;
return zcn0;
}
function zCB6(zcp12,zcq1,zci2){
var zct9=zCU0();var zca8=zct9-zcp12;var zce5=0;var zcz0;
for(var i=0;i<zcq1.length;i++){
var zcq4=zcq1[i].split(',');
for(var j=1;j<zcq4.length;j++){
zcz0=zci2[zce5].split(',');
zcz0[1]=zcz0[1]-zca8;
if(zcz0[1]<=0){
zcq4.splice(j,1);
zci2.splice(zce5,1);
...
return zct9+'B'+zcq1.join(':')+'|'+zci2.join(':');
}
function zCB2(zcx12,zcv11,zce12){
var zcn13=zcx12-zcv11+1;var zcn0=zcn13+zce12-1;
return zcn0;
}
function zCU2(zcz13,zcq1,zci2){
var zcv9=zCU0();var zca8=zcv9-zcz13;var zca5=0;
for(var i=0;i<zcq1.length;i++){
var zcq0=zcq1[i].split(',');
for(var j=1;j<zcq0.length;j++){
var zcn7=zcq0[j].split('#');
for(var k=1;k<zcn7.length;k++){
zcz0=zci2[zca5].split(',');
zcz0[1]=zcz0[1]-zca8;
if(zcz0[1]<=0){
zci2.splice(zca5,1);
zcn7.splice(k,1);
...
return zcv9+'B'+zcq1.join(':')+'|'+zci2.join(':');
}
function zCF3(zcr11){
var zcn1=zCU0();var zcc3=zcr11.split('|');var zcq4=zcc3[0];var zcz0=zcc3[1];var zco0=zcz0.split(':');
for(var idx=0;idx<zco0.length;idx++){
zcc3=zco0[idx].split(',');
zcc3[1]=zCB1(zcc3[1],zcn1);
zcc3.push(1);
zco0[idx]=zcc3.join(',');
}
return zcn1+'B'+zcq4+'|'+zco0.join(':');
}
function zCB1(zcr12,zcp4){
var zcy8;
zcy8=parseInt(zcr12 / 24);
return(zcy8>zcp4)?zcy8-zcp4:0;
}
var zct2=new Array();
...
var zcx1=this.zzAct;var zcn8=this.zzActVal;
if(zcx1!=null&&zcx1!=''){
...
var zct10='';
if(zca10==2){
zci4=zCF0('DFFAbh',false);
if(zci4==''){
zci4=zCF0('DFFbh',false);
}}
else if(zca10){
zci4=zCF0('ZFFAbh',false);
if(zci4==''){
zci4=zCF0('ZFFbh',false);
}
}else{
zci4=zCF0('FFAbh',false);
if(zci4==''){
zci4=zCF0('FFbh',false);
}}
if(zci4.length>0){
if(zci4.indexOf('B')==-1){
...
zcc0.zzAct[zcz10]=zcz4[0];
zl_activity_val_score_array=zcz4[1].split("#");;
zcc0.zzActVal[zcz10++]=zl_activity_val_score_array[0];
zcc0.zzActExp[zcz10++]=zl_activity_val_score_array[1];
}}}}}
zcc0.zzDmVal=zcd2;
zcc0.zzDmKey=zcy7;
...
function zzGetBhLength(zcx5,zco5){
if(zco5){
var zci4=zCF0('ZFFAbh',false);
if(zci4==''){
zci4=zCF0('ZFFbh',false);
}
}else{
var zci4=zCF0('FFAbh',false);
if(zci4==''){
zci4=zCF0('FFbh',false);
}}
return zci4.length;
