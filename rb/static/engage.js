    ...
    function initPlugins($R){
        ...
        function plugin_jquery_rdrWidgetSummary($){
            ...
            function _makeSummaryWidget(settings){
                    ...
                    $summary_widget.append('<img src="/static/widget/images/blank.png" style="position:absolute;right:0;top:3px;background:url(/static/widget/images/readr_icons.png) -96px -1px no-repeat;cursor:pointer;width:13px;height:13px;" class="rdr_tooltip_this" title="This is <strong style=\'color:#4d92da;\'>ReadrBoard</strong>. ReadrBoard lets you easily react to anything on this page.<br><br>Click a button to the right to react to this whole page.<br><br>Or -- select any text, image, or video and react to just that part of the page."/>');
