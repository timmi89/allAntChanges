...
!function($) {
    ...
    $.smartbanner.defaults = {
        title: 'NowThis News', // What the title of the app should be in the banner (defaults to <title>)
        author: 'NowThis Media Inc.', // What the author of the app should be in the banner (defaults to <meta name="author"> or hostname)
