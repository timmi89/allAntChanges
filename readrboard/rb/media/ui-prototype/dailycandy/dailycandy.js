...
DAILYCANDY = {
	...
	video: {
		...
		playlist: function(){
				var playlist = [];
				var cookie = $.cookie('dcVideoPlaylist');
	...
	misc: {
		comcastbar: function() {
			...
			if ($.cookie('cmbar') == '1') {
				document.write('<div style="clear:both;width:100%;"><iframe src="http://www.comcast.net/header/vendor/dailycandy/" width="100%" height="22" scrolling="no" frameborder="0" border="0"></iframe></div>');
			}
		}
	},
	ads: {
		...
		if (typeof slides != "undefined") {
			...
			$('#module-flipbook').cycle({ 
				...
				after: function(curr, next, opts){
					...
					window.location = "#"+(DAILYCANDY.flipbook.currentSlide);

					if(DAILYCANDY.flipbook.currentSlide == 1 && prevSlide != 2){
						firstSlide = true;
					}
					...
					if(typeof(s) != "undefined") {
						...
						if(firstSlide) {
							firstSlide = false;
							trackQueue.push(pageName + refactorPageName + "1");
						}
