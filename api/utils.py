...
def getSummary(interactions, container=None, content=None, page=None, data=None):
    ...
    top_interactions['coms'] = [dict(id=comment.id, tag_id=comment.parent.interaction_node.id, user=comment.user, body=comment.interaction_node.body) for comment in comments]
