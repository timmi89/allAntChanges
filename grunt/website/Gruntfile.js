...
module.exports = function(grunt) {
    ...
    var paths = {
        ...
        web_scss_watch_src: [ rootDir + '/rb/static/site/sass/*.scss',rootDir + '/rb/static/site/sass/antenna_components/*.scss',rootDir + '/rb/static/site/sass/materialize_components/*.scss' ],
