...
public class AntennaConstants {

    public static final String ID_WIDGET_BUCKET = "antenna-widget-bucket";

    public static final String CLASS_SUMMARY_WIDGET = "ant-summary-widget";
