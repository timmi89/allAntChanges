...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'JSONGlobalReport'
        db.create_table(u'analytics_jsonglobalreport', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('kind', self.gf('django.db.models.fields.CharField')(default='tvhrc', max_length=5)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('body', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'analytics', ['JSONGlobalReport'])


    def backwards(self, orm):
        # Deleting model 'JSONGlobalReport'
        db.delete_table(u'analytics_jsonglobalreport')


    models = {
        u'analytics.jsonglobalreport': {
            'Meta': {'object_name': 'JSONGlobalReport'},
