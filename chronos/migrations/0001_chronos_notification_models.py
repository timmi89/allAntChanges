...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chronos_notificationrule', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
        ))
        db.send_create_signal('chronos', ['NotificationRule'])

        # Adding model 'NotificationType'
        db.create_table('chronos_notificationtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('email_template', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('chronos', ['NotificationType'])

        # Adding M2M table for field rules on 'NotificationType'
        db.create_table('chronos_notificationtype_rules', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('notificationtype', models.ForeignKey(orm['chronos.notificationtype'], null=False)),
            ('notificationrule', models.ForeignKey(orm['chronos.notificationrule'], null=False))
        ))
        db.create_unique('chronos_notificationtype_rules', ['notificationtype_id', 'notificationrule_id'])

        # Adding model 'InteractionNotification'
        db.create_table('chronos_interactionnotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('notification_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chronos.NotificationType'])),
        ))
        db.send_create_signal('chronos', ['InteractionNotification'])

        # Adding unique constraint on 'InteractionNotification', fields ['interaction', 'social_user', 'notification_type']
        db.create_unique('chronos_interactionnotification', ['interaction_id', 'social_user_id', 'notification_type_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'InteractionNotification', fields ['interaction', 'social_user', 'notification_type']
        db.delete_unique('chronos_interactionnotification', ['interaction_id', 'social_user_id', 'notification_type_id'])

        # Deleting model 'NotificationRule'
        db.delete_table('chronos_notificationrule')

        # Deleting model 'NotificationType'
        db.delete_table('chronos_notificationtype')

        # Removing M2M table for field rules on 'NotificationType'
        db.delete_table('chronos_notificationtype_rules')

        # Deleting model 'InteractionNotification'
        db.delete_table('chronos_interactionnotification')
    ...
    models = {
        ...
        'chronos.interactionnotification': {
            'Meta': {'unique_together': "(('interaction', 'social_user', 'notification_type'),)", 'object_name': 'InteractionNotification'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interaction': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rb.Interaction']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'notification_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chronos.NotificationType']"}),
            'social_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['rb.SocialUser']"})
        },
        'chronos.notificationrule': {
            'Meta': {'object_name': 'NotificationRule'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'})
        },
        'chronos.notificationtype': {
            'Meta': {'object_name': 'NotificationType'},
            'email_template': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'rules': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['chronos.NotificationRule']", 'symmetrical': 'False'})
        },
