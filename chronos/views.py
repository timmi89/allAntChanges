                ...
                if passed:
                    ...
                    if created:
                        ...
                        msg = EmailMultiAlternatives(
                            "[Antenna] Someone agreed with you!",
                            '',
                            "hello@antenna.is",
                            [social_user.user.email]
                        )
                        msg.attach_alternative(generateAgreeEmail(
                            social_user.user,
                            child_count,
                            interaction
                        ), "text/html")
...
def group_node(request, interaction_id = None, group_id = None, **kwargs):
    ...
    try:
        ...
        for admin in group.admins.all():
            #SEND EMAIL!
            msg = EmailMultiAlternatives(
                "[Antenna] A new reaction just appeared on your site",
                '',
                "hello@antenna.is",
                [admin.user.email]
            )
            ...
            for threshold in thresholds:
                ...
                if passed:
                   ...
                   # if created:
                    ...
                    msg = EmailMultiAlternatives(
                        "[Antenna] Someone commented on your reaction!",
                        '',
                        "hello@antenna.is",
                    ...
                    # if social_user.notification_email_option:
                        for threshold in page_rules:
                            if (
                                ...
                                msg = EmailMultiAlternatives(
                                    "[Antenna] Someone reacted to the same page as you!",
                                    '',
                                    "hello@antenna.is",
                                    [p_i.user.email]
                                )
