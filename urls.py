...
urlpatterns = patterns(
    ...
    url(r'^user/(?P<user_id>\d+)/tags/$',
        'rb.views.main', kwargs={"view": "tags"}),
    url(r'^user/(?P<user_id>\d+)/comments/$',
        'rb.views.main', kwargs={"view": "comments"}),
    url(r'^user/(?P<user_id>\d+)/shares/$',
        'rb.views.main', kwargs={"view": "shares"}),
    url(r'^user/(?P<user_id>\d+)/bookmarks/$',
        'rb.views.main', kwargs={"view": "bookmarks"}),
    ...
    url(r'^page/(?P<page_id>\d+)/not_approved/$',
        'rb.views.main', kwargs={"admin": "not_approved"}),
    url(r'^page/(?P<page_id>\d+)/tags/$',
        'rb.views.main', kwargs={"view": "tags"}),
    url(r'^page/(?P<page_id>\d+)/comments/$',
        'rb.views.main', kwargs={"view": "comments"}),
    url(r'^page/(?P<page_id>\d+)/shares/$',
        'rb.views.main', kwargs={"view": "shares"}),
    url(r'^page/(?P<page_id>\d+)/bookmarks/$',
        'rb.views.main', kwargs={"view": "bookmarks"}),

    # Specific site
    url(r'^site/(?P<site_id>\d+)/$', 'rb.views.main'),
    url(r'^site/(?P<site_id>\d+)/not_approved/$',
        'rb.views.main', kwargs={"admin": "not_approved"}),
    url(r'^site/(?P<site_id>\d+)/tags/$',
        'rb.views.main', kwargs={"view": "tags"}),
    url(r'^site/(?P<site_id>\d+)/comments/$',
        'rb.views.main', kwargs={"view": "comments"}),
    url(r'^site/(?P<site_id>\d+)/shares/$',
        'rb.views.main', kwargs={"view": "shares"}),
    url(r'^site/(?P<site_id>\d+)/bookmarks/$',
        'rb.views.main', kwargs={"view": "bookmarks"}),

    # Specific group
    url(r'^group/(?P<short_name>[\w\-\.]+)/$', 'rb.views.main'),
    url(r'^group/(?P<short_name>[\w\-\.]+)/not_approved/$',
        'rb.views.main', kwargs={"admin": "not_approved"}),
    url(r'^group/(?P<short_name>[\w\-\.]+)/tags/$',
        'rb.views.main', kwargs={"view": "tags"}),
    url(r'^group/(?P<short_name>[\w\-\.]+)/comments/$',
        'rb.views.main', kwargs={"view": "comments"}),
    url(r'^group/(?P<short_name>[\w\-\.]+)/shares/$',
        'rb.views.main', kwargs={"view": "shares"}),
    url(r'^group/(?P<short_name>[\w\-\.]+)/bookmarks/$',
        'rb.views.main', kwargs={"view": "bookmarks"}),
    url(
        r'^group/(?P<short_name>[\w\-\.]+)/analytics/(?P<year>\d+)/' + \
        '(?P<month>\d+)/(?P<day>\d+)/$',
        'rb.views.analytics'),
    url(r'^group/(?P<short_name>[\w\-\.]+)/analytics/$', 'rb.views.analytics'),
    url(
        r'^group/(?P<short_name>[\w\-\.]+)/emails/publisher_content_report/$',
    ...
    url(r'^favicon\.ico$', RedirectView.as_view(
        url='/static/site/images/favicon.ico')),
    ...
    # dont expose the signup form anymore for now.  We'll use the wufoo form
    # and onboard ourselves - redirect them.
    ...
    url(r'^group/(?P<short_name>[\w\-\.]+)/unapproved_reactions/$',
        'rb.views.group_unapproved_tags'),  # unapproved == unblessed
    ...
    url(
        r'^group/(?P<short_name>[\w\-\.]+)/admin_approve/(?P<request_id>\d+)/$',
     'rb.views.admin_approve'),
